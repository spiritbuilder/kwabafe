...
const RequestLoan = () => {
  ...
  return (
    <div className="  xl:w-1/3 lg:w-2/5 md:w-2/5  sm:w-3/5 w-full   p-6 self-center justify-self-center rounded-md border border-kwabapurplelight">
      <div className="flex justify-between center">
        <div className=" text-kwabapurplelight font-bold">
          Hi, {auth.authentication.fullname ? auth.authentication.fullname : ""}
        </div>
        <div
